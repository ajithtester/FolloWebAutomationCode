...
public class Follo_05_Members extends Baseclass {
	...
	public void user_clicks_members_button() throws Throwable {
		...
		try {
			...
			String Storydescription = "Members button is not clicked" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
			
		}
	}

	@Given("User invites already invited member")
	public void user_invites_already_invited_member() throws Throwable {
		
		try {

			F_05_Members.NegativeInviteMembers();
			...
			String IssueSummary = e.getMessage() ;
			String Storydescription = "User invites already invited member" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
		}
		}
	...
	public void user_enters_invite_members_button() throws Throwable {
		...
		try {
			...
			String IssueSummary = e.getMessage() ;
			String Storydescription = "Invite members button is not clicked" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
	...
	public void user_enters_members_mailid() throws Throwable {
		...
		try {
			...
			String IssueSummary = e.getMessage() ;
			String Storydescription = "Invite not sent to the users" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
		}
	}
	...
	public void user_assign_company_and_role_to_the_member() throws Throwable {
		...
		try {
			...
			String IssueSummary = e.getMessage() ;
			String Storydescription = "company and role not assigned to the members" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
	...
	public void user_clicks_send_invite_button() throws Throwable {
		...
		try {
			...
			String IssueSummary = e.getMessage() ;
			String Storydescription = "Send invites button is not clicked" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
		}
	...
	public void user_should_see_the_invite_sent_success_message() throws Throwable {
		...
		try {
			...
			PrintError(e.getMessage());
			ReportConfig.Thenlogfail("User should see the invite sent success message","Send invites button is not clicked because : " + e.getMessage());
	...
	public void user_edit_a_member_from_the_list() throws Throwable {
		try {
			...
			String IssueSummary = e.getMessage() ;
			String Storydescription = "Members are not edited" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
	...
	public void user_search_and_view_the_members() throws Throwable {
		...
		try {
			...
			String IssueSummary = e.getMessage() ;
			String Storydescription = "Members are not searched" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
	...
	public void user_send_reinvites_to_the_pending_members() throws Throwable {
		...
		try {
			...
			String IssueSummary = e.getMessage() ;
			String Storydescription = "Reinvites are not sent to members" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
	...
	public void user_search_and_filter_the_company_based_on_role() throws Throwable {
		...
		try {
			...
			String IssueSummary = e.getMessage() ;
			String Storydescription = "Members are not filtered" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
		}
	...
	public void user_selects_all_members() throws Throwable {
		...
		try {
			...
			String IssueSummary = e.getMessage() ;
			String Storydescription = "All members are not selected" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
		}
	...
	public void all_the_members_except_origin_member_should_be_deleted() throws Throwable {
		...
		try {
			...
			ReportConfig.Thenlogpass("All the members except origin member should be deleted","All memebers are not removed because : " + e.getMessage());

			String IssueSummary = e.getMessage() ;
			String Storydescription = "All memebers are not removed" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
