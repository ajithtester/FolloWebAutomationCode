...
public class Follo_06_Gate extends Baseclass{
	...
	public void user_clicks_gate_button() throws Throwable {
		...
		try {
			...
			String Storydescription = "Gates button is not clicked" ;
	...
	public void user_adds_new_gate() throws Throwable {
		...
		try {
			...
			String IssueSummary = e.getMessage() ;
			String Storydescription = "Gates are not added" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
		}
	...
	public void user_edit_a_gate_from_the_list() throws Throwable {
		...
		try {
			...
			String IssueSummary = e.getMessage() ;
			String Storydescription = "Gates are not edited" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
	...
	public void user_delete_a_gate_from_the_list() throws Throwable {
		...
		try {
			...
			String IssueSummary = e.getMessage() ;
			String Storydescription = "Gates are not deleted" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
		}
	}
	...
	public void user_select_all_gates() throws Throwable {
		...
		try {
			...
			String IssueSummary = e.getMessage() ;
			String Storydescription = "All gates are not selected" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
	...
	public void user_clicks_remove_button_and_click_yes_from_the_delete_popup() throws Throwable {
		...
		try {
			...
			String IssueSummary = e.getMessage() ;
			String Storydescription = "Detele button is not clicked" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
		}
	}
	...
	public void all_the_gates_should_be_deleted() throws Throwable {
		...
		try {
			...
			String IssueSummary = e.getMessage() ;
			String Storydescription = "All gates are not deleted" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
		}
	...
	public void user_search_and_view_the_gates() throws Throwable {
		...
		try {
			...
			String IssueSummary = e.getMessage() ;
			String Storydescription = "Gates are not searched" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
	...
	@Given("user adds gate name that exceeds maximum length")
	public void user_adds_gate_name_that_exceeds_maximum_length() throws Throwable {
	   
		try {

			ReportConfig.ReportCreateScenarioTest("user adds gate name that exceeds maximum length");
			
			F_06_Gate.MaximumCharacterLength();
		} 

		catch (Exception e) {

			PrintError(e.getMessage());
			ReportConfig.Givenlogfail("user adds gate name that exceeds maximum length" , "Add gate failed Because : " + e.getMessage());

			String IssueSummary = e.getMessage() ;
			String Storydescription = "user adds gate name that exceeds maximum length" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
