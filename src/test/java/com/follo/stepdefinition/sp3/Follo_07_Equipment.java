...
public class Follo_07_Equipment extends Baseclass {
	...
	public void user_clicks_equipment_button() throws Throwable {
		...
		try {
			...
			String Storydescription = "Equipment button is not clicked" ;
	...
	public void user_adds_new_equipment() throws Throwable {
		...
		try {
			...
			String IssueSummary = e.getMessage() ;
			String Storydescription = "Equipment not added" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
		}
	...
	public void user_edit_a_equipment_from_the_list() throws Throwable {
		...
		try {
			...
			String IssueSummary = e.getMessage() ;
			String Storydescription = "Equipment not edited" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
	...
	public void user_filter_the_company_based_on_equipment_name() throws Throwable {
		...
		try {
			...
			String IssueSummary = e.getMessage() ;
			String Storydescription = "Equipment not filtered" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
	...
	public void user_search_and_view_the_equipment() throws Throwable {
		...
		try {
			...
			String IssueSummary = e.getMessage() ;
			String Storydescription = "Equipment not searched" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
	...
	public void user_delete_a_equipment_from_the_list() throws Throwable {
		...
		try {
			...
			String IssueSummary = e.getMessage() ;
			String Storydescription = "Equipment not deleted" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
	...
	public void user_selects_all_equipment() throws Throwable {
		...
		try {
			...
			String IssueSummary = e.getMessage() ;
			String Storydescription = "All equipments are not selected" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
	...
	public void all_the_equipment_should_be_deleted() throws Throwable {
		...
		try {
			...
			String IssueSummary = e.getMessage() ;
			String Storydescription = "All equipments are not deleted" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
	...
	@Given("user adds equipment name that exceeds maximum length")
	public void user_adds_equipment_name_that_exceeds_maximum_length() throws Throwable {
	   
		try {
			ReportConfig.ReportCreateScenarioTest("user adds equipment name that exceeds maximum length");
			F_07_Equipment.MaximumCharacterLength();
		} 

		catch (Exception e) {

			PrintError(e.getMessage());
			ReportConfig.Givenlogfail("user adds equipment name that exceeds maximum length","User adds equipment failed : " + e.getMessage());
