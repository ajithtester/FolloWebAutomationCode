...
public class Follo_08_DeliveryCalendar extends Baseclass {
	...
	public void user_clicks_delivery_calendar_button() throws Throwable {
		...
		//	Click("DFOW", DFOWLocators);
			...
			String Storydescription = "Delivery calendar button is not clicked" ;
	...
	public void user_adds_new_delivery() throws Throwable {
		...
		try {
			...
			PrintError(e.getMessage());
			ReportConfig.Givenlogfail("User adds new delivery","Delivery calendar request not added because : " + e.getMessage());
			
			String IssueSummary = e.getMessage() ;
			String Storydescription = "Delivery calendar request not added" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
		}
	}
	...
	public void user_search_and_view_the_delivery_request() throws Throwable {
		...
		//	ReportConfig.Givenlogpass("User search and view the delivery request","Delivery calendar searched successfully");
			...
			String IssueSummary = e.getMessage() ;
			String Storydescription = "Delivery calendar request not searched" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
	...
	public void user_edit_a_delivery_request() throws Throwable {
		...
		//	ReportConfig.Givenlogpass("User edit a delivery request","Delivery calendar edited successfully");
			...
			String IssueSummary = e.getMessage() ;
			String Storydescription = "Delivery calendar request not edited" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
	...
	public void user_filter_the_delivery_request_based_on_company_name() throws Throwable {
		...
		//	ReportConfig.Givenlogpass("User filter the delivery request based on company name","Delivery calendar filtered successfully");
			...
			String IssueSummary = e.getMessage() ;
			String Storydescription = "Delivery calendar request not filtered" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
	...
	public void user_view_the_request_info() throws Throwable {
		...
		//	ReportConfig.Givenlogpass("User view the request info","Delivery calendar info viewed successfully");
			...
			String IssueSummary = e.getMessage() ;
			String Storydescription = "Delivery calendar request info not viewed" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
	...
	public void user_add_a_comment() throws Throwable {
		...
		//	ReportConfig.Andlogpass("User add a comment","User add a comment successfully");
			...
			String IssueSummary = e.getMessage() ;
			String Storydescription = "Delivery calendar request, Comment not added" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
		}
	...
	public void user_view_history() throws Throwable {
		...
		//	ReportConfig.Andlogpass("User view history","History viewed successfully");
			...
			String IssueSummary = e.getMessage() ;
			String Storydescription = "Delivery calendar request, History not viewed" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
		}
	...
	//		ReportConfig.Thenlogpass("User delivers the request","Request delivers successfully");
			...
			PrintError(e.getMessage());
			ReportConfig.Thenlogfail("User delivers the request","Request not delivered because : " + e.getMessage());
			
			String IssueSummary = e.getMessage() ;
			String Storydescription = "Delivery calendar request not delivered" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
	...
	public void user_approve_or_reject_the_request() throws Throwable {
		...
		//	ReportConfig.Givenlogpass("User approve or reject the request","User approve or reject the request successfully");
			...
			String IssueSummary = e.getMessage() ;
			String Storydescription = "Delivery calendar request, Approve or reject failed" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
	...
	//		ReportConfig.Givenlogpass("User push a delivery request to void","Request pushed to void successfully");
			...
			String IssueSummary = e.getMessage() ;
			String Storydescription = "Delivery calendar request, pushed to void failed" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
	...
	//		ReportConfig.Givenlogpass("User add attachment to the delivery delivery request", "Attcahment added successfully");
			...
			String IssueSummary = e.getMessage() ;
			String Storydescription = "Delivery calendar request, Attcahment add failed" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
			
		}
	}
	
	@Given("User uploads invalid date time in Delivery Calendar")
	public void user_uploads_invalid_date_time_in_Delivery_Calendar() throws Throwable {
		
		try {

			ReportConfig.ReportCreateScenarioTest("User uploads invalid date time in Delivery Calendar");
			F_08_DeliveryCalendar.AddDeliverRequestError();	


		} 
		catch (Exception e) {
			PrintError(e.getMessage());
			ReportConfig.Givenlogfail("User uploads invalid date time in Delivery Calendar", "Add deliver request error failed because : " + e.getMessage());

			
			String IssueSummary = e.getMessage() ;
			String Storydescription = "User uploads invalid date time in Delivery Calendar" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
