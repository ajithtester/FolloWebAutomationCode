...
import com.follo.module.method.F_15_Dashboard;
...
public class Follo_15_Dashboard extends Baseclass {
	...
	public void user_clicks_dashboard() throws Throwable, IOException {
		...
		try {
			...
			PrintError("DashBoard validation started");
			...
			String Storydescription = "Dashboard button is not clicked" ;
	...
	public void user_clicks_no_of_delivers() throws Throwable {
		...
		try {
			...
			String IssueSummary = e.getMessage() ;
			String Storydescription = "No Of Deliveries button is not clicked" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
	...
	public void user_should_be_redirected_to_deliver_request() throws Throwable {
		...
		try {
			...
			String IssueSummary = e.getMessage() ;
			String Storydescription = "Delivery request page is not displayed" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
	...
	public void user_clicks_no_of_companies() throws Throwable {
		...
		try {
			...
			String IssueSummary = e.getMessage() ;
			String Storydescription = "No Of Companies button is not clicked" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
	...
	public void user_should_be_redirected_to_companies() throws Throwable {
		...
		try {
			...
			String IssueSummary = e.getMessage() ;
			String Storydescription = "Company page is not displayed" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
	...
	public void user_clicks_no_of_members() throws Throwable, IOException {
		...
		try {
			...
			String IssueSummary = e.getMessage() ;
			String Storydescription = "No Of Members button is not clicked" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
	...
	public void user_should_be_redirected_to_members() throws Throwable {
		...
		try {
			...
			String IssueSummary = e.getMessage() ;
			String Storydescription = "Member page is not displayed " ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
	...
	public void user_clicks_no_of_equipment() throws Throwable {
		...
		try {
			...
			String IssueSummary = e.getMessage() ;
			String Storydescription = "No Of Equipments button is not clicked" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
	...
	public void user_should_be_redirected_to_equipment() throws Throwable {
		...
		try {
			...
			String IssueSummary = e.getMessage() ;
			String Storydescription = "Equipment page is not displayed" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
	...
	public void user_validate_the_no_of_deliveries() throws Throwable  {
		...
		try {
			...
			if(IsEqual(CountFromDashboard, CountFromList)) {
				...
				String IssueSummary = (("Dashboard value : " + CountFromDashboard + " , No of requests : " + CountFromList)) ;
				String Storydescription = "User validate the no of deliveries" ;
				pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
	...
	public void user_validate_the_no_of_companies() throws Throwable, IOException {
		...
		try {
			...
			if(IsEqual(CountFromDashboard, CountFromList)) {
				...
				String IssueSummary = ("Dashboard value : " + CountFromDashboard + " , No of Companies : " + CountFromList) ;
				String Storydescription = "User validate the no of deliveries" ;
				pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
			...
			String IssueSummary = e.getMessage() ;
			String Storydescription = "User validate the no of companies" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
	...
	public void user_validate_the_no_of_members() throws Throwable, IOException {
		...
		try {
			...
			if(IsEqual(CountFromDashboard, CountFromList)) {
				...
				String IssueSummary = ("Dashboard value : " + CountFromDashboard + " , No of members : " + CountFromList);
				String Storydescription = "User validate the no of members" ;
				pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
	...
	public void user_validate_the_no_of_equipment() throws Throwable, IOException {
		...
		try {
			...
			if(IsEqual(CountFromDashboard, CountFromList)) {
				...
				String IssueSummary = ("Dashboard value : " + CountFromDashboard + " , No of equipments : " + CountFromList);
				String Storydescription = "User validate the no of equipment" ;
				pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
	...
	public void user_adds_a_request() throws Throwable {
		...
		try {
			...
			String IssueSummary = e.getMessage() ;
			String Storydescription = "Request add failed" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
	...
	public void user_adds_a_company() throws Throwable {
		...
		//	ReportConfig.Givenlogpass("User adds a Company to the list","Company added successsfully");
			...
			String IssueSummary = e.getMessage() ;
			String Storydescription = "Company add failed" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
	...
	public void user_adds_a_members() throws Throwable {
		...
		//	ReportConfig.Givenlogpass("User adds a members to the list","Members added successsfully");
			...
			String IssueSummary = e.getMessage() ;
			String Storydescription = "Members add failed" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
	...
	public void user_adds_a_equipment() throws Throwable {
		...
		//	ReportConfig.Givenlogpass("User adds a Company to the list","Equipment added successsfully");
			...
			ReportConfig.Givenlogfail("User adds a Company to the list","Equipment add failed because : " + e.getMessage());
			PrintError(e.getMessage());

			String IssueSummary = e.getMessage() ;
			String Storydescription = "Equipment add failed" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
	...
	public void validate_the_no_of_deliveries() throws Throwable {
		...
		try {
			...
			if(IsEqual(CountFromDashboard, CountFromList)) {
				...
				String Storydescription = "validate the no of deliveries" ;
				String IssueSummary = ("Dashboard value : " + CountFromDashboard + " , No of deliveries in the list : " + CountFromList) ;
				pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
	...
	public void user_deletes_a_company() throws Throwable {
		...
		//	ReportConfig.Givenlogpass("User deletes a Company from the list","Company deleted successsfully");
			...
			String IssueSummary = e.getMessage() ;
			String Storydescription = "Company deleted failed" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
		}
	...
	public void validate_the_no_of_companies() throws Throwable {
		...
		try {
			...
			if(IsEqual(CountFromDashboard, CountFromList)) {
				...
				String IssueSummary = ("Dashboard value : " + CountFromDashboard + " , No of companies in the list : " + CountFromList) ;
				String Storydescription = "validate the no of companies" ;
				pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
	...
	//		ReportConfig.Givenlogpass("User deletes a member from the list","Members deleted successsfully");
			...
			ReportConfig.Givenlogfail("User deletes a members from the list","Members delete failed because : " + e.getMessage());
			PrintError(e.getMessage());

			String IssueSummary = e.getMessage() ;
			String Storydescription = "Members delete failed" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
		}
	...
	public void validate_the_no_of_members() throws Throwable {
		...
		try {
			...
			if(IsEqual(CountFromDashboard, CountFromList)) {
				...
				String IssueSummary = "validate the no of members" ;
				String Storydescription = ("Dashboard value : " + CountFromDashboard + " , No of members : " + CountFromList) ;
				pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
			}
		} catch (Throwable e) {
			Print(e.getMessage());
	...
	//		ReportConfig.Givenlogpass("User deletes a equipment from the list","Equipment deleted successsfully");
			...
			String IssueSummary = e.getMessage() ;
			String Storydescription = "User deletes a equipment" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
		}
	...
	public void validate_the_no_of_equipment() throws Throwable {
		...
		try {
			...
			if(IsEqual(CountFromDashboard, CountFromList)) {
				...
				String IssueSummary = "validate the no of equipment" ;
				String Storydescription = ("Dashboard value : " + CountFromDashboard + " , No of equipment : " + CountFromList) ;
				pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
	...
	public void user_validate_the_upcoming_list() throws Throwable {
		...
		try {
			...
			if(UpcomingList<=10) {
				...
				String IssueSummary = "User validate the upcoming list" ;
				String Storydescription = "Upcoming list has more than 10 values" ;
				pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
			...
			String IssueSummary = e.getMessage() ;
			String Storydescription = "Upcoming list validation failed" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
		}
