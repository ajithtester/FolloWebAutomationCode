...
public class Follo_10_DeliveryRequest extends Baseclass {
	...
	public void user_clicks_all_requests_button_from_the_menu() throws Throwable {
		...
		try {
			...
			ReportConfig.Givenlogfail("User clicks All requests button from the menu","All request button is not clicked because : " + e.getMessage());
		
			String IssueSummary = e.getMessage() ;
			String Storydescription = "All request button is not clicked" ;
	...
	public void user_clicks_delivery_requests_button_from_the_menu() throws Throwable {
		...
		try {
			...
			String IssueSummary = e.getMessage() ;
			String Storydescription = "Delivery request button is not clicked" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
		}
	}
	...
	public void user_add_new_delivery_request() throws Throwable {
		...
		try {
			...
			String IssueSummary = e.getMessage() ;
			String Storydescription = "Delivery request add failed" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
	...
	public void user_search_and_view_the_delivery_request_from_the_list() throws Throwable {
		...
		try {
			...
			String IssueSummary = e.getMessage() ;
			String Storydescription = "Delivery request search failed" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
	...
	public void user_edit_a_delivery_request_from_the_list() throws Throwable {
		...
		try {
			...
			String IssueSummary = e.getMessage() ;
			String Storydescription = "Delivery request edit failed" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
	...
	public void user_view_the_request_information() throws Throwable {
		...
		try {
			...
			String IssueSummary = e.getMessage() ;
			String Storydescription = "Delivery request info viewed failed" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
	...
	public void user_view_the_history_of_the_request() throws Throwable {
		...
		try {
			...
			String IssueSummary = e.getMessage() ;
			String Storydescription = "Delivery request history view failed" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
	...
	public void user_deliver_the_request() throws Throwable {
		...
		try {
			...
			String IssueSummary = e.getMessage() ;
			String Storydescription = "Delivery request deliver failed" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
	...
	public void user_approve_or_reject_the_delivery_request() throws Throwable {
		...
		try {
			...
			String IssueSummary = e.getMessage() ;
			String Storydescription = "Delivery request ApproveOrReject is failed" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
	...
	public void user_push_a_request_to_void() throws Throwable {
		...
		try {
			...
			String IssueSummary = e.getMessage() ;
			String Storydescription = "User pushed a request to void failed" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
			
		}
	}

	@Given("User uploads invalid date time in Delivery Request")
	public void user_uploads_invalid_date_time_in_Delivery_Request() throws Throwable {

		try {

			Wait(2000);
			ReportConfig.ReportCreateScenarioTest("To check invalid date time error in Delivery Request");
			Click("DeliveryRequestFromMenu", DeliveryRequestLocators);
			Print("Delivery request button is clicked");
			ReportConfig.Givenlogpass("User uploads invalid date time in Delivery Request" ,"Delivery request button is clicked");	

			F_10_DeliveryRequest.AddDeliverRequestError();	


		} 
		catch (Exception e) {
			PrintError(e.getMessage());
			ReportConfig.Givenlogfail("User uploads invalid date time in Delivery Request" ,"Add deliver request error failed because : " + e.getMessage());	

			String IssueSummary = e.getMessage() ;
			String Storydescription = "Add deliver request error failed" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
	...
	@Given("User uploads invalid file in DeliveryRequest")
	public void user_uploads_invalid_file_in_DeliveryRequest() throws Throwable {

		try {
			ReportConfig.ReportCreateScenarioTest("To check invalid file error in import list");
			F_10_DeliveryRequest.InvalidFileError();

		}
		catch (Exception e) {

			PrintError(e.getMessage());
			ReportConfig.Givenlogfail("User uploads invalid file in DeliveryRequest" ,"failed because : " + e.getMessage());	

			String IssueSummary = e.getMessage() ;
			String Storydescription = "User uploads invalid file in DeliveryRequest" ;
			pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary);
