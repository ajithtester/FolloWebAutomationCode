...
public class F_12_CalendarSettings extends Baseclass {
	...
	public static void AddEvent() throws Throwable {
		PrintError("AddEvent Calendar settings started");
	...
	public static void SearchEvent() throws Throwable {
		PrintError("Search Calendar settings started");
...
//				
//					String IssueSummary = "Searched value is : " +  ReadFrom.Excel(SearchCalendarSettingsRequest, 2, ReadFrom.SearchCalendarSettingsRequest) + "but displayed value is : " + DeliveryRequestName ;
//					String Storydescription = "Search event request" ;
//					pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary );
	...
	public static void EditEvent() throws Throwable {
		PrintError("EditEvent Calendar settings started");
	...
	public static void AddEventError() throws Throwable {
		PrintError("AddEventError Calendar settings started");
		ReadFrom.DynamicExcel(ReadFrom.CalendarSettingsRequest);


		for(int CalendarAddRequest =1; CalendarAddRequest<=1; CalendarAddRequest++)		{	
			...
			if(IsElementDisplayed("Description", CalendarSettingsLocators)) {
				Print("Calendar request popup is opened");
				ReportConfig.Givenlogpass("User uploads invalid date time in CalendarSettings" ,"Calendar request popup is opened");
			}
			...
			if(IsEqual(AllDay, "No")) {
				...
				Click("AllDay", CalendarSettingsLocators);
				Print("All day option is selected");
				ReportConfig.Givenlogpass("User uploads invalid date time in CalendarSettings" ,"All day option is selected");
			}
			...
			if(IsEqual(DeliveryCalendar, "No")) {
				...
				Click("DeliveryCalendar", CalendarSettingsLocators);
				Print("Delivery calendar option is selected");
				ReportConfig.Givenlogpass("User uploads invalid date time in CalendarSettings" ,"Delivery calendar option is selected");
			...
			if(IsEqual(CraneCalendar, "No")) {
				...
				Click("CraneCalendar", CalendarSettingsLocators);
				Print("Crane calendar option is selected");
				ReportConfig.Givenlogpass("User uploads invalid date time in CalendarSettings" ,"Crane calendar option is selected");
			...
			Click("CancelButton", CalendarSettingsLocators);
