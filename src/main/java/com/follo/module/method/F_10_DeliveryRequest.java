...
public class F_10_DeliveryRequest extends Baseclass {
	...
	public static void AddDeliverRequest() throws Throwable {
		PrintError("Add delivery request Started");
		...
		for(int AllDeliverRequest =1; AllDeliverRequest<=ReadFrom.rowcount; AllDeliverRequest++)		{	
			...
			else
			{
				...
				String Storydescription = "Add delivery request" ;
			...
			if(IsElementDisplayed("DeliveryAdded", DeliveryRequestLocators)) {
				...
				ReportConfig.Givenlogfail("User adds new delivery","Delivery calendar not added");
	...
	public static void SearchRequest() throws Throwable {
		...
		PrintError("Search delivery request Started");
...
//				
//					String IssueSummary = "Searched value is : " + ReadFrom.Excel(Search, 0, ReadFrom.SearchRequest) + "but displayed value is : " + Requestname ;
//					String Storydescription = "Search request" ;
//					pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary );
	...
	public static void EditRequest() throws Throwable {
		PrintError("Edit delivery request started");
				...
				if(IsEqual(DeliveryName, EditIt)) {
					...
					try {
					...
					} catch (Exception e) {
						{
							...
							ReportConfig.Givenlogpass("User edit a delivery request from the list","Delivery request equipment is  selected");
					...
					if(IsElementDisplayed("DeliveryUpdated", DeliveryRequestLocators)) {
						...
						String IssueSummary = "Delivery Request Updated Successfully is not displayed" ;
						String Storydescription = "Update delivery request" ;
						pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary );
					}	
	...
	public static void FilterRequest() throws Throwable {
		...
		PrintError("Filter delivery request Started");
	...
	public static void ViewRequestInfo() throws Throwable {
		...
		PrintError("View delivery request info started");
	...
	public static void AddComment() throws Throwable {
		PrintError("Add comment delivery request started");
	...
	public static void ViewHistoryInfo() throws Throwable {
		PrintError("View delivery request history info started");
	...
	public static void Attachment() throws Throwable {
		...
		PrintError("delivery request Attachment started");
	...
	public static void Deliver() throws Throwable {
		...
		PrintError("Deliver delivery request started");
	...
	public static void ApproveOrReject() throws Throwable {
		PrintError("Approve or reject delivery request started");
			...
			for(int DeliveryLists =1; DeliveryLists<=rowcount; DeliveryLists++)		{
				...
				if(IsEqual(DeliveryName, DeliverIt)) {
					...
					if (IsEqual(Status, "Approved")) {
						...
						Click("ApprovedSuccessfully", DeliveryRequestLocators);
						...
						Click("DeclinedSuccessfully", DeliveryRequestLocators);
	...
	public static void PushToVoid() throws Throwable {
		PrintError("Push to void delivery request started");
			...
			for(int DeliveryLists =1; DeliveryLists<=rowcount; DeliveryLists++)		{
				...
				if(IsEqual(DeliveryName, DeliverIt)) {
					...
					if(IsElementDisplayed("VoidSuccessfull", DeliveryRequestLocators)) {
						...
						String IssueSummary = "Delivery Request Marked as Void Successfully popup is not displayed" ;
						String Storydescription = "Delivery Request Push to void" ;
						pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary );
					}	
	...
	public static void AddDeliverRequestError() throws Throwable {
		PrintError("Add Deliver RequestError deliver request Started");

			for(int AllDeliverRequest =1; AllDeliverRequest<=1; AllDeliverRequest++)		{	
				...
				{
					PrintError("Create new button is not clicked");
					ReportConfig.Givenlogpass("User uploads invalid date time in Delivery Request" ,"Create new button is not clicked");
			
					String IssueSummary = "Create new button is not clicked" ;
					String Storydescription = "Add Deliver Request Error" ;
					pt_Integration.CreateStory.post_Story(Storydescription , IssueSummary );
				...
				if(IsElementDisplayed("Description", DeliveryRequestLocators)) {
					Print("Delivery popup is opened");
					ReportConfig.Givenlogpass("User uploads invalid date time in Delivery Request" ,"Delivery popup is opened");
				}
				...
				try {
					...
					{
						Print("Delivery request equipment is selected");
						ReportConfig.Givenlogpass("User uploads invalid date time in Delivery Request" ,"Delivery request equipment is selected");
				...
				String InvalidTime =	GetText("InvalidTime", DeliveryRequestLocators);
				...
				Click("CancelButton", DeliveryRequestLocators);
...
public static void InvalidFileError() throws Throwable {
	PrintError("InvalidFileError deliver request Started");
		Wait(2000);
