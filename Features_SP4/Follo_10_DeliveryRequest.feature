Feature: To verify the Delivery request
  ...
  @DeliveryRequest @Regression @NegativeCases
  ...
  @DeliveryRequest @Regression
  Scenario: User view the request information
    Given User view the request information

  @DeliveryRequest @Regression
  Scenario: User add a comment to the request
    Given User add a comment to the request

  @DeliveryRequest @Regression
  Scenario: User view the history of the request
    Given User view the history of the request

  @DeliveryRequest @Regression
  Scenario: User add attachment to the deliver request
    Given User add attachment to the deliver request

  @DeliveryRequest @Regression
  Scenario: User delivers the delivery request
  ...
  @DeliveryRequest @NegativeCases @Regression
  Scenario: To check invalid date time error in Delivery Request
